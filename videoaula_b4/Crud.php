...
class Crud
{
   ...
   public function readInfo($id = null){
    ...
    public function update($id,$nome,$idade,$email){
      ...
      if($sql->execute()){
        echo "Registro Atualizado! <br> <button><a href='readAll.php'>Voltar</a></button>";
      }else{
        echo "Problemas ao Atualizar Registro! <br> <button type='button'> <a href='readAll.php'>Voltar</a>
        </button>";
      }
    }
    public function delete($id){
      ...
      if($sql->execute()){
        echo "Registro Deletado! <br> <button type='button'> <a href='readAllDelete.php'>Voltar</a> </button>";
      }else{
        echo "Problemas ao Deletar Registro! <br> <button type='button'> <a href='readAllDelete.php'>Voltar</a> 
        </button>";
      }
    }       
}